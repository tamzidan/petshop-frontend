...
const Products = () => {
  ...
  // Get unique pet types from products
  const petTypes = useMemo(() => {
    const types = products
      .map((product) => product.pet?.name)
  ...
  const filteredProducts = useMemo(() => {
    return products.filter((product) => {
      ...
      const matchesPetType =
        selectedPetType === 'all' || product.pet?.name === selectedPetType;
  ...
  }, [products, searchQuery, selectedPetType, priceRange]);
              ...
              <Card key={product.id}>
                ...
                <div className="p-6">
                  ...
                  <Link
                    ...
                    className="inline-block w-full text-center bg-primary-400 text-white px-4 py-2 rounded-full font-semibold hover:bg-primary-500 transition-colors mt-4"
                  >
                    View Details
                  </Link>
                </div>
